...
#list of the colors of the bricks
COLOR_LIST = [colormodel.RED, colormodel.ORANGE, colormodel.YELLOW,
              colormodel.GREEN, colormodel.CYAN]
#the radius of the ball in pixels
BALL_RADIUS = BALL_DIAMETER/2

#state when all tries are used up
STATE_COMPLETE = 5

#list of all sounds
LIST_OF_SOUNDS = ['cup1.wav', 'plate1.wav', 'plate2.wav',
                  'saucer1.wav', 'saucer2.wav']
